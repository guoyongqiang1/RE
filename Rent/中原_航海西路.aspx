<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="中原_航海西路.aspx.cs" Inherits="WebApplication1.中原_航海西路" %>
...
&nbsp;
        ...
        <tr>
            <td class="auto-style1">
                ...
                &nbsp;
                <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click" >航海西路</asp:LinkButton>
&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click" >帝湖</asp:LinkButton>
&nbsp;
                 <br />
                
                <br />
                <asp:GridView ID="GridView1" runat="server" Height="290px" Width="569px" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True">
                    <Columns>
