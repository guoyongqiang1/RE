...
namespace Rent
{
    public partial class userDaiJieZhangHouse : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    string sql = "select * from house where houseState='商议中' and UserID='" + Users.userID + "'";
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        NonZuLe.Text = "去结账";
                        NonZuLe.NavigateUrl = "jieZhangPage.aspx?JhouseID=" + dt.Rows[i].ItemArray[0].ToString();
