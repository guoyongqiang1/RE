<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="中原路段.aspx.cs" Inherits="WebApplication1.经纪人" %>
...
&nbsp;
                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click1" >二七</asp:LinkButton>
&nbsp;
                <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click1" >金水</asp:LinkButton>
        ...
        <tr>
            <td class="auto-style1">
                ...
                &nbsp;
                <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" >碧沙岗</asp:LinkButton>
                &nbsp;
                <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click1" >航海西路</asp:LinkButton>
&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click1" >帝湖</asp:LinkButton>
&nbsp;
                
                <br />
                
                <br />
                <asp:GridView ID="GridView1" runat="server" Height="290px" Width="569px" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging">
                    <Columns>
