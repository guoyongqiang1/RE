<%@ Page Language="C#" MasterPageFile="~/headerAndFooter.Master" AutoEventWireup="true" CodeBehind="金水_绿城广场.aspx.cs" Inherits="WebApplication1.金水_绿城广场" %>
...
&nbsp;
        ...
        <tr>
            <td class="auto-style1">
                ...
                &nbsp;
                <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" >博颂路</asp:LinkButton>
                &nbsp;
                <asp:LinkButton ID="LinkButton6" runat="server" OnClick="LinkButton6_Click1" >黄河路</asp:LinkButton>
&nbsp;&nbsp;
                <asp:LinkButton ID="LinkButton7" runat="server" OnClick="LinkButton7_Click1" >绿城广场</asp:LinkButton>
&nbsp;
